...
4. If you want the ability to reload an app using Server Side Extensions, you need to add the same configuration as in the previous step, in the *Settings.ini* file for QVB. The path to the configuration file for QVB can be found on the Qlik Help site ([link](https://help.qlik.com/en-US/qlikview/November2017/Subsystems/Server/Content/QlikView-Server/QVSRM_Batch.htm)).
